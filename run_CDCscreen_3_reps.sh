#!/usr/bin/bash
if [ ! $# = 14 ]; then
    echo "Usage: `basename $0` ref_gRNA_seq.fa FPBcirc.txt D1_rep1_R1.fq D1_rep1_R2.fq D1_rep2_R1.fq D1_rep2_R2.fq D1_rep3_R1.fq D1_rep3_R2.fq D30_rep1_R1.fq D30_rep1_R2.fq D30_rep2_R1.fq D30_rep2_R2.fq D30_rep3_R1.fq D30_rep3_R2.fq";
    echo "[run_CDCscreen_3_reps.sh was used for 3 biology replicates]";
    echo "";
    echo "    Maintainer:";
