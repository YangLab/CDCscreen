#!/usr/bin/bash
if [ ! $# = 14 ]; then
    echo "### `basename $0` was used for 3 biology replicates ###";
    echo "";
    echo "Usage:";
    echo "    `basename $0` ref_gRNA_seq.fa FPBcirc.txt D1_rep1_R1.fq D1_rep1_R2.fq D1_rep2_R1.fq D1_rep2_R2.fq D1_rep3_R1.fq D1_rep3_R2.fq D30_rep1_R1.fq D30_rep1_R2.fq D30_rep2_R1.fq D30_rep2_R2.fq D30_rep3_R1.fq D30_rep3_R2.fq";
    echo "";
    echo "Maintainer:";
    ...
    echo "    3. Raw FASTQ files (Paired-End reads, 3 biology replicates of control [Day 1] and treatment [Day 30], full path of raw data is recommended)";
    ...
    echo "      - D1_rep3_R1.fq and D1_rep3_R2.fq (Day 1 of biology replicate 3)";
    ...
    echo "      - D30_rep3_R1.fq and D30_rep3_R2.fq (Day 30 of biology replicate 3)";
    exit 0;
fi
...
ln -s $7 01_D1_rep3_R1.fastq.gz
ln -s $8 01_D1_rep3_R2.fastq.gz

ln -s $9 01_D30_rep1_R1.fastq.gz
ln -s ${10} 01_D30_rep1_R2.fastq.gz
ln -s ${11} 01_D30_rep2_R1.fastq.gz
ln -s ${12} 01_D30_rep2_R2.fastq.gz
ln -s ${13} 01_D30_rep3_R1.fastq.gz
ln -s ${14} 01_D30_rep3_R2.fastq.gz
...
# D1 rep3 R1 rm3p
cutadapt -a TTTTTTAAGCTTGGCGTAACTAGATCT -m 15 -o 02_D1_rep3_R1_rm3p.fq 01_D1_rep3_R1.fastq.gz
# D1 rep3 R1 rm5p
cutadapt -g CCCTACCAACTGGTCGGGGTTTGAAAC -m 15 -o 02_D1_rep3_R1_trimmed.fq 02_D1_rep3_R1_rm3p.fq
# D1 rep3 R2 rm3p
cutadapt -a GTTTCAAACCCC -m 15 -o 02_D1_rep3_R2_rm3p.fq 01_D1_rep3_R2.fastq.gz
## cutadapt -a GTTTCAAACCCCGACCAGTTGGTAGGG -m 15 -o 02_D1_rep3_R2_rm3p.fq 01_D1_rep3_R2.fastq.gz
# D1 rep3 R2 rm5p
cutadapt -g AGATCTAGTTACGCCAAGCTTAAAAAA -m 15 -o 02_D1_rep3_R2_trimmed.fq 02_D1_rep3_R2_rm3p.fq
...
# D30 rep3 R1 rm3p
cutadapt -a TTTTTTAAGCTTGGCGTAACTAGATCT -m 15 -o 02_D30_rep3_R1_rm3p.fq 01_D30_rep3_R1.fastq.gz
# D30 rep3 R1 rm5p
cutadapt -g CCCTACCAACTGGTCGGGGTTTGAAAC -m 15 -o 02_D30_rep3_R1_trimmed.fq 02_D30_rep3_R1_rm3p.fq
# D30 rep3 R2 rm3p
cutadapt -a GTTTCAAACCCC -m 15 -o 02_D30_rep3_R2_rm3p.fq 01_D30_rep3_R2.fastq.gz
## cutadapt -a GTTTCAAACCCCGACCAGTTGGTAGGG -m 15 -o 02_D30_rep3_R2_rm3p.fq 01_D30_rep3_R2.fastq.gz
# D30 rep3 R2 rm5p
cutadapt -g AGATCTAGTTACGCCAAGCTTAAAAAA -m 15 -o 02_D30_rep3_R2_trimmed.fq 02_D30_rep3_R2_rm3p.fq

rm 02_D1_rep1_R1_rm3p.fq 02_D1_rep1_R2_rm3p.fq 02_D1_rep2_R1_rm3p.fq 02_D1_rep2_R2_rm3p.fq 02_D1_rep3_R1_rm3p.fq 02_D1_rep3_R2_rm3p.fq 02_D30_rep1_R1_rm3p.fq 02_D30_rep1_R2_rm3p.fq 02_D30_rep2_R1_rm3p.fq 02_D30_rep2_R2_rm3p.fq 02_D30_rep3_R1_rm3p.fq 02_D30_rep3_R2_rm3p.fq
...
cat ../02_bowtie_align/05_D1_rep3_R1_trimmed.txt ../02_bowtie_align/05_D1_rep3_R2_trimmed.txt |sort -k1,1n |awk '{a[$1]+=$2;b[$1]++}END{for(n in a)print n"\t"a[n]}' |sort -k1,1n > 01_D1_rep3.txt
...
cat ../02_bowtie_align/05_D30_rep3_R1_trimmed.txt ../02_bowtie_align/05_D30_rep3_R2_trimmed.txt |sort -k1,1n |awk '{a[$1]+=$2;b[$1]++}END{for(n in a)print n"\t"a[n]}' |sort -k1,1n > 01_D30_rep3.txt

# 3.2 combine gRNA reads
perl ../combine_diff.pl -in "01_D1_rep1.txt,01_D1_rep2.txt,01_D1_rep3.txt,01_D30_rep1.txt,01_D30_rep2.txt,01_D30_rep3.txt" -out 02_mapped_reads.tmp -suff bed -fill none
...
perl -alne 'next if $F[0]=~/#/; next if $F[0] eq "Geneid"; $rpk=0; $rpk=$F[3] if $F[3]>0; $totalrpk += $rpk; push @gene,$F[0];push @generpk,$rpk; END{ $scale=$totalrpk/100000; for($i=0;$i<=$#gene;$i++){$,="\t";print $gene[$i],$generpk[$i]/$scale+1;} }' 02_gRNA_reads.txt > 03_gRNA_D0_rep3.txt
perl -alne 'next if $F[0]=~/#/; next if $F[0] eq "Geneid"; $rpk=0; $rpk=$F[4] if $F[4]>0; $totalrpk += $rpk; push @gene,$F[0];push @generpk,$rpk; END{ $scale=$totalrpk/100000; for($i=0;$i<=$#gene;$i++){$,="\t";print $gene[$i],$generpk[$i]/$scale+1;} }' 02_gRNA_reads.txt > 03_gRNA_D30_rep1.txt
perl -alne 'next if $F[0]=~/#/; next if $F[0] eq "Geneid"; $rpk=0; $rpk=$F[5] if $F[5]>0; $totalrpk += $rpk; push @gene,$F[0];push @generpk,$rpk; END{ $scale=$totalrpk/100000; for($i=0;$i<=$#gene;$i++){$,="\t";print $gene[$i],$generpk[$i]/$scale+1;} }' 02_gRNA_reads.txt > 03_gRNA_D30_rep2.txt
perl -alne 'next if $F[0]=~/#/; next if $F[0] eq "Geneid"; $rpk=0; $rpk=$F[6] if $F[6]>0; $totalrpk += $rpk; push @gene,$F[0];push @generpk,$rpk; END{ $scale=$totalrpk/100000; for($i=0;$i<=$#gene;$i++){$,="\t";print $gene[$i],$generpk[$i]/$scale+1;} }' 02_gRNA_reads.txt > 03_gRNA_D30_rep3.txt
paste 03_gRNA_D0_rep1.txt 03_gRNA_D0_rep2.txt 03_gRNA_D0_rep3.txt 03_gRNA_D30_rep1.txt 03_gRNA_D30_rep2.txt 03_gRNA_D30_rep3.txt |cut -f 1,2,4,6,8,10,12 > 03_normalized_gRNA_reads.txt

# 3.4 mean of normalized reads in rep1, rep2 and rep3
awk '{print $0"\t"($2+$3+$4)/3"\t"($5+$6+$7)/3}' 03_normalized_gRNA_reads.txt > 04_normalized_gRNA_reads_mean.txt

# 3.5 Fold change of rep1, rep2, rep3 and mean of rep1, rep2, rep3
awk '{FS="\t";OFS="\t"}{print $1,$2,$3,$4,$5,$6,$7,$8,$9,($5+0.01)/($2+0.01),($6+0.01)/($3+0.01),($7+0.01)/($4+0.01),($9+0.01)/($8+0.01)}' 04_normalized_gRNA_reads_mean.txt |sort -k1,1 > 05_normalized_gRNA_FC.txt
...
cut -f 1,8,9 ../03_gRNA_reads/04_normalized_gRNA_reads_mean.txt > 01_gRNA_normalized_mean.txt
...
# 5.3 Fold change
awk '{printf "%s\t%.1f\n",$1,$13}' ../03_gRNA_reads/05_normalized_gRNA_FC.txt |sed 's/|/\t/g' |awk '{print $1"|"$2"\t"$4}' > 03_gRNA_FC.txt
...
sed 's/|gRNA/\tgRNA/g' ../03_gRNA_reads/05_normalized_gRNA_FC.txt |awk '{if($14<1)print $0}' |awk '{a[$1]+=$14;b[$1]++}END{for(n in a)print n"\t"(a[n]/b[n])}' > 03_circRNA_FC.txt
